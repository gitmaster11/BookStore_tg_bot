...
def join_channel():
    button=  [
        [InlineKeyboardButton("Join Group 🔜",url = 'https://t.me/bookstore_group')],
...
def button_books():
    ...
    res.append(InlineKeyboardButton("Admin 👨🏻‍💻",callback_data = "user",url = 'https://T.me/premium_N11'))
    button.append(res)
    return InlineKeyboardMarkup(button)
...
def quant_button(soni = '0'):
    ...
    res.append(InlineKeyboardButton('Clear 🧹', callback_data = 'clear'))
    button.append(res)
    res = []
